...
module.exports = {
    ...
    storePayment: async (req, res) => {
        const { channel_id, payment_code, email, name, club, date, detail_address, phone,
            size_xl, size_s, size_m, size_l, size_2xl, size_3xl,
            size_4xl, size_5xl, size_6xl, size_7xl
        } = req.body
        
        try {

            var invoiceValue = `JAMNASHTCI-` + date.replace(/[^a-zA-Z0-9\s]/g, '') + '-' + (Math.floor(Math.random() * (99999 - 10000 + 1)) + 10000)
